...
* They have elastic bands on the bottom to go over your boots that prevent snow from getting under them when you fall.
...
| --- | --- |
| <img src="../Images/GloveOff.png" alt="GloveOff" width="200"/> | <img src="../Images/GloveOn.png" alt="GloveOff" width="200"/> |
...
## Head
___Earbud(Only One) -> Face Mask/Balaclava -> Tall Turtleneck/Thick Neck Gaiter -> Helmet -> Goggles___
| Head Setup |
| --- |
| <img src="../Images/HeadSetup.png" alt="HeadSetup" width="200"/> |
* Turtle neck should go over face mask and back of head.
* Ski goggles can have different lenses.
    1. Black Lenses
        * For when the sun is shinning it reflects off the white snow, making it hard to see.
    2. Rose/Yellow Lenses
        * For when the shun is not shinning and the whole mountain turns into one white sheet, making it impossible to see types of upcoming snow, the mountain's topology, and bumps.
        * These lenses accentuate contrast, allowing you to differentiate the different shades of white.
    * Some goggles(like mine) have interchangeable lenses, allowing for you to swap based on conditions.
